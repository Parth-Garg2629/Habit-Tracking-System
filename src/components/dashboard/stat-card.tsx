...
export function StatCard({
  ...
  return (
    <div
      className={cn(
        "group relative overflow-hidden glass system-border",
    ...
    >
      ...
      {/* Subtle corner glow */}
      <div className="pointer-events-none absolute -right-6 -top-6 h-24 w-24 bg-primary/[0.1] blur-2xl transition-all duration-500 group-hover:bg-primary/[0.2]" />
      ...
      <div className="relative p-5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex h-9 w-9 items-center justify-center border border-primary/30 bg-primary/10 text-primary transition-all duration-300 group-hover:bg-primary/20 group-hover:shadow-[0_0_15px_rgba(0,255,255,0.4)]">
